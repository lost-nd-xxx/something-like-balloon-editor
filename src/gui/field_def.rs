...
pub static ACCORDION_GROUPS: &[AccordionGroup] = &[
    ...
    AccordionGroup {
        ...
        fields: &[
            ...
            fd!("cursor.notselect.font.color",           "文字色",     FieldType::Color,    &[], "#000000"),
            fd!("cursor.notselect.font.shadowcolor",     "影色",       FieldType::ColorNone,&[], "none"),
            fd!("cursor.notselect.font.shadowstyle",     "影スタイル", FieldType::Dropdown, SHADOW_CHOICES, "offset"),
    ...
    AccordionGroup {
        ...
        fields: &[
            ...
            fd!("cursor.font.shadowcolor",     "影色",       FieldType::ColorNone,&[], "none"),
            fd!("cursor.font.shadowstyle",     "影スタイル", FieldType::Dropdown, SHADOW_CHOICES, "offset"),
    ...
    AccordionGroup {
        ...
        fields: &[
            ...
            fd!("anchor.notselect.font.color",           "文字色",     FieldType::Color,    &[], "#000000"),
            fd!("anchor.notselect.font.shadowcolor",     "影色",       FieldType::ColorNone,&[], "none"),
            fd!("anchor.notselect.font.shadowstyle",     "影スタイル", FieldType::Dropdown, SHADOW_CHOICES, "offset"),
    ...
    AccordionGroup {
        ...
        fields: &[
            ...
            fd!("anchor.font.color",           "文字色",     FieldType::Color,    &[], "#000000"),
            fd!("anchor.font.shadowcolor",     "影色",       FieldType::ColorNone,&[], "none"),
            fd!("anchor.font.shadowstyle",     "影スタイル", FieldType::Dropdown, SHADOW_CHOICES, "offset"),
            fd!("anchor.pen.color",            "枠色",       FieldType::Color,    &[], "#7F7F00"),
    ...
    AccordionGroup {
        ...
        fields: &[
            ...
            fd!("anchor.visited.font.color",           "文字色",     FieldType::Color,    &[], "#555555"),
            fd!("anchor.visited.font.shadowcolor",     "影色",       FieldType::ColorNone,&[], "none"),
            fd!("anchor.visited.font.shadowstyle",     "影スタイル", FieldType::Dropdown, SHADOW_CHOICES, "offset"),
